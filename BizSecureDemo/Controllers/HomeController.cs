...
public class HomeController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        ViewBag.AllOrders = allOrders; //Submits all orders to the View through the ViewBag.The ViewBag is a "bag" for additional data to the View.Thus, the View can also display a public list of orders.
